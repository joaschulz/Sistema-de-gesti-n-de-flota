...
// ========================================================
    ...
    // ========================================================
    public function enviarATaller($patente, $tipo, $detalle, $costo, $listaEvidencias, $idUsuario) {
        $pdo = Conexion::conectar();
        try {
            ...
            $sql2 = "INSERT INTO INTERVENCION_TECNICA (fecha_inicio, costo, tipo_falla, detalles, ID_usuario, patente) 
                     VALUES (NOW(), :costo, :tipo, :detalle, :idUsuario, :patente)";
